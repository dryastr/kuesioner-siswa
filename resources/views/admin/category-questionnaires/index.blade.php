...
@section('title', 'Questionnaire Categories')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title">Daftar Kategori Questionnaires</h4>
                                            ...
                                            <td class="text-nowrap">
                                                <div class="dropdown dropup">
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        ...
                                                        <li>
                                                            <form action="{{ route('category-questionnaires.destroy', $category->id) }}"
                                                                method="POST"
    ...
    <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('category-questionnaires.store') }}" method="POST">
                    @csrf
...
@push('scripts')
    <script>
        function editCategory(category) {
            document.getElementById('editCategoryForm').action = `/category-questionnaires/${category.id}`;
